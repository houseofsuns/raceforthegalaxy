...
require_once(__DIR__.'/modules/php/OrbTrait.php');
require_once(__DIR__.'/modules/php/InvasionTrait.php');
require_once(__DIR__.'/modules/php/DebugTrait.php');
require_once(__DIR__.'/modules/php/MigrationTrait.php');
require_once(__DIR__.'/modules/php/HtmlGenerationTrait.php');
require_once(__DIR__.'/modules/php/GoalsTrait.php');
